...
function spaceShipBase()
{
 shape.call(this); // Inherit class shape’s array members by calling parent constructor
 this.populate(); // It immediately populates its arrays
 this.init_buffers(); // Then sends its arrays to the graphics card into new buffers
}
inherit(spaceShipBase, shape);
 spaceShipBase.prototype.populate = function()
 {

 //var theta = Math.PI - ( Math.atan(0.3/0.2) + (Math.PI/2) );
 //var phi = Math.PI - ( Math.atan(1.6/0.5) + (Math.PI/2) );

var a = 1/Math.sqrt(3);
var v1 = vec3(-0.3,0.3,0.5);
var v2 = vec3(0.3,0.3,0.5);
var v3 = vec3(-0.8,0.3,-1);
var v4 = vec3(0.8,0.3,-1);
var v5 = vec3(-0.5,0,1);
var v6 = vec3(0.5,0,1);
var v7 = vec3(1,0,-1);
var v8 = vec3(-1,0,-1);
...
// Method 2: A tetrahedron with four independent triangles.
	//bottom layer
 this.vertices.push( v5, v6, v7 ); //567
 this.vertices.push(  v5, v7, v8 ); //578




 //top layer
 this.vertices.push( v1, v2, v4); //124
 this.vertices.push(  v1, v4, v3 ); //143
 
 //front 
 this.vertices.push( v1, v2, v6 ); //126
 this.vertices.push(  v1, v5, v6 ); //156

  //sideR
 this.vertices.push( v2, v4, v6 );
 this.vertices.push(  v4, v6, v7 ); 


 //sideL
 this.vertices.push( v1, v3, v5 ); 
 this.vertices.push(  v3, v5, v8 ); 


  //back
 this.vertices.push( v3, v4, v7 ); 
 this.vertices.push(  v3, v7, v8 ); 

 this.texture_coords.push( vec2(0,0), vec2(0,1), vec2(1,1) );
 this.texture_coords.push( vec2(0,0), vec2(1,1), vec2(1,0) );
 ...
 this.texture_coords.push( vec2(0,1), vec2(1,1), vec2(0,0) );
 this.texture_coords.push( vec2(0,1), vec2(0,0), vec2(1,0) );
...
function asteroid(){
 ...
 inherit(asteroid, shape);
 asteroid.prototype.populate = function(){
	...
	var v9 = vec3(0, gri, gr);
	var v10 = vec3(0, gri, -gr);
	var v11 = vec3(0, -gri, gr);
	var v12 = vec3(0, -gri, -gr);

	var v13 = vec3(gri, gr, 0);
	var v14 = vec3(gri, -gr, 0);
	var v15 = vec3(-gri, gr, 0);
	var v16 = vec3(-gri, -gr, 0);

	var v17 = vec3(gr, 0, gri);
	var v18 = vec3(gr, 0, -gri);
	var v19 = vec3(-gr, 0, gri);
	var v20 = vec3(-gr, 0, -gri);

	//pentagons to be made:
	//1,2,17,18,13:
	//1,2,13
	//1,2,17
	//17,18,2
	...
	this.vertices.push( v1, v2, v13 ); 
	this.vertices.push(  v1, v2, v17 ); 
	this.vertices.push(  v17, v18, v2 ); 
	...
	this.vertices.push( v2, v18, v4 ); 
	this.vertices.push(  v2, v4, v12 ); 
	this.vertices.push(  v2, v12, v10 ); 
	...
	this.vertices.push( v2, v13, v15 ); 
	this.vertices.push(  v2, v15, v6 ); 
	this.vertices.push(  v2, v6, v10 ); 

	//pentagon 4:
	this.vertices.push( v13, v1, v9); 
	this.vertices.push(  v13, v9, v5 ); 
	this.vertices.push(  v13, v5, v15 ); 

	//pentagon 5:
	this.vertices.push( v1, v9, v11); 
	this.vertices.push(  v1, v11, v3 ); 
	this.vertices.push(  v1, v3, v17 ); 

	//pentagon 6:
	this.vertices.push( v3, v17, v18); 
	this.vertices.push(  v3, v18, v4 ); 
	this.vertices.push(  v3, v4, v14 ); 

	//pentagon 7:
	this.vertices.push( v3, v11, v7); 
	this.vertices.push(  v3, v7, v16 ); 
	this.vertices.push(  v3, v16, v14 ); 

	//pentagon 8:
	this.vertices.push( v4, v14, v16); 
	this.vertices.push(  v4, v16, v8 ); 
	this.vertices.push(  v4, v8, v12 ); 

	//pentagon 9:
	this.vertices.push( v8, v16, v7); 
	this.vertices.push(  v8, v7, v19 ); 
	this.vertices.push(  v8, v19, v20); 

	//pentagon 10:
	this.vertices.push( v8, v12, v10); 
	this.vertices.push(  v8, v10, v6 ); 
	this.vertices.push(  v8, v6, v20); 

	//pentagon 11:
	this.vertices.push( v7, v11, v9); 
	this.vertices.push(  v7, v9, v5 ); 
	this.vertices.push(  v7, v5, v19); 

	//pentagon 12:
	this.vertices.push( v5, v15, v6); 
	this.vertices.push(  v5, v6, v20); 
	this.vertices.push(  v5, v20, v19); 
